...
from dataset.CarDataset import CarDataset
from dataset.CLWDDataset import CLWDDataset 
import numpy as np

from trainers.TAWRTrainer import TAWRTrainer
...
def main(args):
    ...
    if args.dataset == 'clwd':
        dataset_func = CLWDDataset
    elif args.dataset == 'cars':
        dataset_func = CarDataset
    else:
